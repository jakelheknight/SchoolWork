...
public class FileIncriptor {
	// File uses some basic encryption techniques and saves as an encrypted file.
	...
	public static void main(String[] args) {
		...
		//Open file catch file not found.
		 try{
			 ...
			 while(Fin.hasNext()){
				 thisLn = Fin.nextLine();
				Fout1.println(Encryption1(thisLn));
				Fout2.println(Encryption2(thisLn));
			 }
			 Fin.close();
			 read.close();
			 Fout1.close();
			 ...
			 System.out.println("Could not find the file or could not write the file. Make sure its in the same directory as this program.");
		 }
	}
